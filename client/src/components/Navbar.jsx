...
const NavBarItem = ({ title, classprops }) => {
  ...
  switch (title) {
    case "GitHub":
      link = "https://github.com/priyanshuirl";
      break;
    case "LinkedIn":
      link = "https://www.linkedin.com/in/priyanshuirl/";
      break;
    case "Instagram":
      link = "https://www.instagram.com/priyanshu_irl_/";
      break;
    case "E-Mail":
      link = "mailto:priyanshu12651265@gmail.com";
      break;
    default:
      console.log("nah fam");
      break;
